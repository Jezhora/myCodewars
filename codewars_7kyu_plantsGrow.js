...
function growingPlant(upSpeed, downSpeed, desiredHeight) {
  //coding and coding..
  let days = 0;
  for (let i = upSpeed; i < desiredHeight; i = (i - downSpeed) + upSpeed) {
    days++;
  }
  return days + 1;
}
...
// The number of days that it will take for the plant
// to reach/pass desiredHeight (including the last day in the total count).